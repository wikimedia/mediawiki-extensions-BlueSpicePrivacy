...
class CookieAcceptMandatory extends BooleanSetting implements ISettingPaths {
	...
	public function getLabelMessageKey() {
		return 'bs-privacy-prefs-cookieacceptmandatory-label';
	}
	...
	public function getHelpMessageKey() {
		return 'bs-privacy-prefs-cookieacceptmandatory-help';
	}
}
